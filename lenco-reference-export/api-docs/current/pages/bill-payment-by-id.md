...
Retrieve information about a specific bill payment
...
```json
{
  ...
  "paths": {
    "/bills/{id}": {
      "get": {
        "summary": "/bills/:id",
        "description": "Retrieve information about a specific bill payment",
        "operationId": "bill-payment-by-id",
        "parameters": [
          {
            "name": "id",
            "in": "path",
  ...
  "_id": "60633ad0d7e9d4000f4916b9:62a899a1d69b5c006467e6bf"
}
```
