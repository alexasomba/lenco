...
```json
{
  ...
  "paths": {
    "/point-of-sale/transactions": {
      "get": {
        "summary": "/point-of-sale/transactions",
        "description": "",
        "operationId": "get-pos-transactions",
        "parameters": [
          {
            "name": "page",
            "in": "query",
          ...
          },
          {
            "name": "terminalId",
            "in": "query",
            "description": "Optional. The assigned POS terminal id.",
            "schema": {
              "type": "string"
            }
          },
          ...
          },
          {
            "name": "status",
            "in": "query",
            "description": "Optional. Either `successful`, or `failed`",
            "schema": {
              "type": "string",
          ...
          },
          {
            "name": "type",
            "in": "query",
            "description": "Optional. Either `card-payment`, or `transfer`",
            "schema": {
              "type": "string",
  ...
  "_id": "6063101eb8d5d7003e8aa44d:66f1398e2a140300121642f4"
}
```
