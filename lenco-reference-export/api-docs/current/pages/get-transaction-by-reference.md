...
```json
{
  ...
  "paths": {
    "/transaction-by-reference/reference": {
      "get": {
        "summary": "/transaction-by-reference/:reference",
        "description": "Retrieve information about a specific transaction using the client reference",
        "operationId": "get-transaction-by-reference",
        "parameters": [
          {
            "name": "reference",
            "in": "path",
            "description": "The clientReference of the transaction.",
            "schema": {
              "type": "string"
            },
            "required": true
  ...
  "_id": "60633ad0d7e9d4000f4916b9:60639ab6fcd3590029bfedf1"
}
```
