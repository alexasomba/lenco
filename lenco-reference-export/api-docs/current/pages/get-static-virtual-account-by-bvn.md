...
```json
{
  ...
  "paths": {
    "/virtual-account-by-bvn/{bvn}": {
      "get": {
        "summary": "/virtual-account-by-bvn/:bvn",
        "description": "Get a static virtual account details by the bvn",
        "operationId": "get-static-virtual-account-by-bvn",
        "parameters": [
          {
            "name": "bvn",
            "in": "path",
            "description": "The bvn used to generate the static virtual account number",
            "schema": {
              "type": "string"
            },
            "required": true
  ...
  "_id": "60633ad0d7e9d4000f4916b9:6182469bbe5033005c9a5135"
}
```
