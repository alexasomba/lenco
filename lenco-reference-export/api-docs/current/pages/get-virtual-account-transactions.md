...
```json
{
  ...
  "paths": {
    "/virtual-accounts/transactions": {
      "get": {
        "summary": "/virtual-accounts/transactions",
        "description": "Get only successful transactions that occurred on your virtual accounts",
        "operationId": "get-virtual-account-transactions",
        "parameters": [
          {
            "name": "page",
            "in": "query",
          ...
          },
          {
            ...
            "in": "query",
            "description": "Get transactions for a single virtual account using it's account reference",
            "schema": {
              "type": "string"
            }
          },
          {
            ...
            "in": "query",
            "description": "Get transactions for a single virtual account using the `transactionReference` that was passed when creating the account.",
            "schema": {
              "type": "string"
            }
          }
  ...
  "_id": "60633ad0d7e9d4000f4916b9:61824669228dcc00193236c3"
}
```
