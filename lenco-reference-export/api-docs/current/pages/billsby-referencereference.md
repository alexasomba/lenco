...
```json
{
  ...
  "paths": {
    "/bills/by-reference/{reference}": {
      "get": {
        "summary": "/bills/by-reference/:reference",
        "description": "Retrieve information about a specific bill payment using the client reference",
        "operationId": "billsby-referencereference",
        "parameters": [
          {
            "name": "reference",
            "in": "path",
            "description": "The reference (passed by the client) of the bill payment",
            "schema": {
              "type": "string"
            },
            "required": true
  ...
  "_id": "60633ad0d7e9d4000f4916b9:62a89a707ffbce0027789a71"
}
```
